...
const Login = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-red-200 to-gray-900 relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 bg-white/80 shadow-xl rounded-xl px-2 py-6 w-full max-w-xs sm:max-w-lg md:max-w-md border border-red-200 backdrop-blur-md
        sm:px-6 sm:py-8
        md:px-10 md:py-12
        ">
        ...
        <div className="mt-6 sm:mt-8 text-center">
          <span className="text-red-700 font-sans">Don't have an account?</span>
          <Link
            to="/register"
